...
const saveKey = 'darts-event-alert.saved'
const postKey = 'darts-event-alert.posts'
const alerts = [
  {
    "id": "darts-event-alert-1",
    "title": "設置店 alert seed 1",
    "area": "名古屋",
    "category": "設置店",
    "score": 95,
    "summary": "DARTSLIVE設置店、大会、空き台、キャンペーンを通知し、店舗送客と用品アフィリエイトにつなげる。 設置店の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  {
    "id": "darts-event-alert-2",
    "title": "大会 alert seed 2",
    "area": "東京",
    "category": "大会",
    "score": 92,
    "summary": "DARTSLIVE設置店、大会、空き台、キャンペーンを通知し、店舗送客と用品アフィリエイトにつなげる。 大会の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール"
  ...
  {
    "id": "darts-event-alert-3",
    "title": "空き台 alert seed 3",
    "area": "大阪",
    "category": "空き台",
    "score": 89,
    "summary": "DARTSLIVE設置店、大会、空き台、キャンペーンを通知し、店舗送客と用品アフィリエイトにつなげる。 空き台の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール",
  ...
  {
    "id": "darts-event-alert-4",
    "title": "キャンペーン alert seed 4",
    "area": "静岡",
    "category": "キャンペーン",
    "score": 86,
    "summary": "DARTSLIVE設置店、大会、空き台、キャンペーンを通知し、店舗送客と用品アフィリエイトにつなげる。 キャンペーンの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <p className="eyebrow">ダーツ台・大会通知</p>
          <h1>Darts Event Alert</h1>
          <p className="lead">DARTSLIVE設置店、大会、空き台、キャンペーンを通知し、店舗送客と用品アフィリエイトにつなげる。</p>
        </div>
        <aside className="hero-panel">
          <span>dartsevent.jp / darts-event-alert</span>
